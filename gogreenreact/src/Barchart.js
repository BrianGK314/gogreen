...
const BarChart = ({ isDashboard = false }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(getFunc("getBar")); // Replace with your actual API endpoint
  ...
  return (
    <ResponsiveBar
      ...
      keys={["Technology", "Transport", "Power", "Buildings", "Other", "Manufacturing"]}
      indexBy="country"
      ...
      axisLeft={{
        ...
        tickPadding: 5,
        tickRotation: 0,
        legend: isDashboard ? undefined : "CO2e", // changed
        legendPosition: "middle",
        legendOffset: -40,
      }}
      enableLabel={false}
